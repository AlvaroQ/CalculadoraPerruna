...
// Chart Colors
val ChartBlue = Color(0xFF0050C8)
val ChartRed = Color(0xFFF44336)
val ChartYellow = Color(0xFFFFC107)
val ChartGreen = Color(0xFF00C853)
val ChartBlueDark = Color(0xFF82B1FF)
val ChartRedDark = Color(0xFFFF8A80)
val ChartYellowDark = Color(0xFFFFE57F)
val ChartGreenDark = Color(0xFF69F0AE)
